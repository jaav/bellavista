                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <?php _e('What to show for the root url:', 'sitepress') ?>
                                            ...
                                            <label>
                                                <input type="radio" name="show_on_root" value="html_file" <?php if($sitepress_settings['urls']['show_on_root'] == 'html_file'): 
                                                ?>checked="checked"<?php endif; ?> />
                                            ...
                                            <br />
                                            <label>
                                                <input type="radio" name="show_on_root" value="page" <?php if($sitepress_settings['urls']['show_on_root'] == 'page'): 
                                                ?>checked="checked"<?php endif; ?> />
                                                ...
                                                ?>                                                
                                                <?php if($rp_exists): ?>
                                                <a href="<?php echo get_edit_post_link($sitepress_settings['urls']['root_page']) ?>"><?php _e('Edit root page.') ?></a>
                                                <?php else: ?>
                                                <a href="<?php echo admin_url('post-new.php?post_type=page&wpml_root_page=1') ?>"><?php _e('Create root page.') ?></a>
                                                <?php endif; ?>
                                                </span>                                            
                                            </label>                                            
