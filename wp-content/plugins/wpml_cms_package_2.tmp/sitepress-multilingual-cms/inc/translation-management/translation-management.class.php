...
//            }
    ...
    public function translators_dropdown($args = array()){
        ...
        $translators = apply_filters('cred_wpml_translation_dashboard_check_user',$translators);
        ?>
    ...
    function save_post_actions($post_id, $post, $force_set_status = false){
        ...
        $trid = apply_filters('wpml_tm_save_post_trid_value', isset($trid)?$trid:'');
        $lang = apply_filters('wpml_tm_save_post_lang_value', isset($lang)?$lang:''); 
